...
summary: 동기화 관계를 생성하면 NetApp Copy and Sync 소스에서 대상으로 파일을 복사합니다.  최초 복사 후, 서비스는 24시간마다 변경된 데이터를 동기화합니다. 
---
...
** https://docs.netapp.com/us-en/storage-management-azure-netapp-files/task-quick-start.html["Azure NetApp Files 설정 및 검색"^]
...
** https://docs.netapp.com/us-en/storage-management-ontap-onprem/task-discovering-ontap.html["ONTAP 클러스터 검색"^]
...
+
일정:: 향후 동기화를 위한 반복 일정을 선택하거나 동기화 일정을 해제할 수 있습니다. 데이터를 최소 1분 간격으로 동기화하도록 관계를 예약할 수 있습니다. 일정은 시간별 및 일별 빈도로도 설정할 수 있습니다.
+
--
...
복사 및 동기화는 원본과 대상 간의 데이터 동기화를 시작합니다. 동기화에 소요된 시간, 중단 여부, 복사, 스캔 또는 삭제된 파일 수에 대한 동기화 통계를 확인할 수 있습니다. 그런 다음, link:task-managing-relationships.html["동기화 관계"], link:task-managing-data-brokers.html["데이터 브로커를 관리하세요"], 또는 link:task-managing-reports.html#creating-reports["성능과 구성을 최적화하기 위한 보고서 생성"]을 관리할 수 있습니다.
...
image:screenshot-sync-data-sense.png["NetApp Data Classification 에서 직접 새 동기화를 시작한 후 나타나는 NetApp Data Classification 통합 페이지를 보여주는 스크린샷입니다."]

https://docs.netapp.com/us-en/data-services-data-classification/concept-classification.html["NetApp Data Classification 에서 동기화 관계를 시작하는 방법을 알아보세요."^].
