...
https://docs.netapp.com/us-en/bluexp-classification/task-managing-highlights.html#copying-and-synchronizing-source-files-to-a-target-system["NetApp Data Classification 에서 동기화 관계를 시작하는 방법을 알아보세요."^] .
