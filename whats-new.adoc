...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-linux.html#linux-host-requirements["Linux 호스트 요구 사항 보기"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#create-other-types-of-sync-relationships["*디렉토리 제외* 기능에 대해 자세히 알아보세요."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html["동기화 관계 생성에 대해 자세히 알아보세요."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-aws.html#creating-the-data-broker["AWS에서 데이터 브로커를 만드는 방법에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#create-other-types-of-sync-relationships["*파일 확장자 제외* 기능에 대해 자세히 알아보세요."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-azure.html#creating-the-data-broker["Azure에서 데이터 브로커를 만드는 방법에 대해 자세히 알아보세요."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-azure.html["Azure에서 데이터 브로커를 만드는 방법에 대해 자세히 알아보세요."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/reference-requirements.html#google-cloud-storage-bucket-requirements["Google Cloud Storage 버킷 요구 사항에 대해 자세히 알아보세요."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-relationships.html#deleting-relationships["동기화 관계 삭제에 대해 자세히 알아보십시오."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-copying-acls.html["ACL 복사에 대해 자세히 알아보세요."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings["동기화 시간 초과 설정에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings["개체 복사 설정에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings["파일 유형 설정에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings["최근 수정된 파일 설정에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/api-sync.html["NetApp Copy and Sync 에서 RESTful API를 사용하는 방법에 대해 자세히 알아보세요."].

https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings["제외 디렉터리 설정에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/reference-supported-relationships.html["지원되는 동기화 관계에 대해 자세히 알아보세요."].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-aws.html#details-about-the-data-broker-instance["AWS의 데이터 브로커 인스턴스에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-data-brokers.html["데이터 브로커 그룹 관리에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-azure.html#details-about-the-data-broker-vm["Azure의 데이터 브로커 인스턴스에 대해 자세히 알아보세요."].

https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-gcp.html#details-about-the-data-broker-vm-instance["Google Cloud의 데이터 브로커 인스턴스에 대해 자세히 알아보세요."].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings["디렉터리 이름 제외 설정에 대해 자세히 알아보세요."].
...
----
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings["연속 동기화 설정에 대해 자세히 알아보세요"].
...
+
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-reports.html["보고서에 대해 자세히 알아보세요"].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-relationships.html#setting-up-notifications["알림 설정 방법 알아보기"].
...
Google Drive를 포함하는 동기화 관계를 만들려면 먼저 필요한 권한과 개인 키를 가진 서비스 계정을 설정해야 합니다. https://docs.netapp.com/us-en/data-services-copy-sync/reference-requirements.html#google-drive["Google Drive 요구 사항에 대해 자세히 알아보세요"].

https://docs.netapp.com/us-en/data-services-copy-sync/reference-supported-relationships.html["지원되는 동기화 관계 목록 보기"].
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-enable-drag-and-drop.png["NetApp Console 의 알림 센터를 보여주는 스크린샷입니다."]
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-enable-panel.png["NetApp Console 의 알림 센터를 보여주는 스크린샷입니다."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-relationships.html#change-the-settings-for-a-sync-relationship["동기화 관계 설정 변경에 대해 자세히 알아보세요."].
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-notification-center.png["NetApp Console 의 알림 센터를 보여주는 스크린샷입니다."]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-data-brokers.html["데이터 브로커 그룹을 관리하는 방법을 알아보세요"].
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-filter.png["대시보드 상단의 동기화 상태별 필터링 옵션을 보여주는 스크린샷입니다."]
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-sort.png["대시보드에서 사용할 수 있는 이름별 정렬 옵션을 보여주는 스크린샷입니다."]
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-data-sense.png["Cloud Data Sense에서 직접 새 동기화를 시작한 후 나타나는 Data Sense 통합 페이지를 보여주는 스크린샷입니다."]
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-select-data-broker-group.png["데이터 브로커 그룹 선택을 보여주는 동기화 관계 마법사의 스크린샷입니다."]

*데이터 브로커 관리* 탭에서는 데이터 브로커 그룹이 관리하는 동기화 관계의 수도 표시됩니다.

image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-group-relationships.png["데이터 브로커 그룹과 해당 그룹에 대한 세부 정보(관리 중인 관계 수 포함)를 보여주는 데이터 브로커 관리 페이지의 스크린샷입니다."]
...
* https://docs.netapp.com/us-en/storage-management-fsx-ontap/start/concept-fsx-aws.html["Amazon FSx for ONTAP 에 대해 알아보세요"^]
