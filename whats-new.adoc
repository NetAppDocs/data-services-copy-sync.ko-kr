...
summary: NetApp Copy and Sync의 새로운 기능을 알아보세요. 
---
...
https://docs.netapp.com/us-en/bluexp-copy-sync/api-sync.html["NetApp Copy and Sync에서 RESTful API를 사용하는 방법에 대해 자세히 알아보세요."] .
...
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-copy-sync/main/media/screenshot-enable-drag-and-drop.png["NetApp 콘솔의 알림 센터를 보여주는 스크린샷입니다."]
...
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-copy-sync/main/media/screenshot-enable-panel.png["NetApp 콘솔의 알림 센터를 보여주는 스크린샷입니다."]
